...
function libraries() {
  return src(sourceFolder + '/libraries/**/*')
    .pipe(dest(buildFolder + '/libraries'))
};
...
function serve() {
  ...
  watch(sourceFolder + '/libraries/**/*', series(libraries)).on('change', sync.reload)
};


exports.build = series(clear, scss, js, img, sprite, fonts, html, libraries);
exports.watch = series(clear, scss, js, img, svg, sprite, fonts, html, serve, libraries);
exports.bem = bem;
exports.clear = clear;